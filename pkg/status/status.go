...
func (gs *GlobalStatus) PrintResultAsJSON(w io.Writer, schema *gemini.Schema, version string) error {
...
func (gs *GlobalStatus) PrintResult(w io.Writer, schema *gemini.Schema, version string) {
